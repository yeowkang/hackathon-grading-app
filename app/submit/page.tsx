...
const fields: { key: keyof Omit<FormData, 'teamMembers'>; label: string; hint: string; rows: number; maxLength?: number }[] = [
  ...
  { key: 'useCase', label: 'Use Case Summary', hint: 'A one-liner on what your solution does — e.g. "Automates invoice approvals by routing them to the right approver based on amount and department."', rows: 1, maxLength: 100 },
